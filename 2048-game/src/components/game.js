            ...
            <div>
                <div className="heading">
                    ...
                    <div className="scores-container">
                        <div className="score-container">{this.state.score}</div>
                    </div>
                </div>
                ...
                <p className="game-over">{this.state.message}</p>
                ...
                <div className="game-explanation-container">
                    <p className="game-explanation">
                        ...
                        <span className="game-explanation-mouse">Use your <strong>arrow keys </strong></span>
